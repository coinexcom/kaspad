...
import (
	...
	"github.com/coinexcom/kaspad/domain/consensus/utils/virtual"
...
func (v *blockValidator) checkCoinbaseSubsidy(
	...
	for _, parent := range parents {
		...
		// The pruning proof ( https://github.com/coinexcom/docs/blob/main/Reference/prunality/Prunality.pdf ) concludes
